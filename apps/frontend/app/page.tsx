...
import { Activity, Database, Loader2, LogIn, LogOut, Send, Terminal, User } from 'lucide-react';
...
export default function Home() {
    ...
    const { user, quotaRemaining, bucketCapacity, isLoading, error, loginGuest, logout, initAuth } = useAuthStore();
            ...
            >
                ...
                <div className="flex items-center gap-3">
                    {user ? (
                        <>
                            <div className="flex items-center gap-2">
                                <Badge variant="outline" className="text-xs font-semibold gap-1.5 py-1 px-2.5 bg-[#f8fafc] border-[#cbd5e1] text-[#0f172a]">
                                    <User className="h-3.5 w-3.5 text-[#004ea1]" aria-hidden="true" />
                                    <span>{user.name}</span>
                                </Badge>
                                <Badge variant="soft" className="text-xs font-bold bg-[#e8f3fc] text-[#004ea1] border border-[#93c5fd]">
                            ...
                            <Button
                                ...
                                variant="outline"
                                onClick={logout}
                                className="text-xs font-medium gap-1.5 h-8 border-[#cbd5e1] hover:bg-[#f8fafc]"
                            >
                            ...
                            <DialogContent className="sm:max-w-xs">
                                ...
                                <div className="flex flex-col gap-2.5 pt-2">
                                    <Button
                                        variant="outline"
                                        disabled
                                        className="w-full justify-center gap-2 text-xs font-medium border-[#cbd5e1] opacity-60 cursor-not-allowed"
                                    ...
                                    >
                                        ...
                                        <span>Google Sign In (Setup Pending)</span>
                                    </Button>
                                    <Button
                                        variant="secondary"
                                        disabled={isLoading}
                                    ...
                                    >
                                        ...
                                        <span>{isLoading ? 'Creating Guest Pass...' : 'Guest Sign In'}</span>
                                    </Button>
